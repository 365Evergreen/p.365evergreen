...
import styles from './RelatedPostsGrid.module.css'
import type { RelatedPostsGridProps } from './RelatedPostsGrid.types'
  ...
  return (
    <section className={styles.section} aria-labelledby="related-posts-heading">
      ...
      <div className={styles.layout}>
        <div>
          <label htmlFor="related-posts-search" className={styles.searchLabel}>
            Search posts
          </label>
          <input
